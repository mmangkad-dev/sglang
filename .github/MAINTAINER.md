...
3. Someone tags the PR with a `run-ci` label ([help](https://docs.sglang.io/developer_guide/contribution_guide.html#how-to-trigger-ci-tests)). Applying the label manually triggers CI for the current commit; later pushes trigger it again.
