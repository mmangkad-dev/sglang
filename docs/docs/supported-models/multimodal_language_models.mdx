...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    ...
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}><strong>North Micro Vision</strong> (Cohere)</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}><code>CohereLabs/North-Micro-Vision-Instruct</code></td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}>Cohere's 2.4B native-resolution VLM (<code>CohereCompassForConditionalGeneration</code>): a 400M SigLIP-2-derived vision encoder with DeepStack fusion on a Command-A style text decoder that interleaves sliding-window M-RoPE layers with global NoPE layers. Multilingual, multi-image, and strong on OCR, charts, documents, and grounding.</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Multimodal prompts are validated up to 8K tokens; grounding boxes are returned on a normalized 0-1000 scale.</td>
    </tr>
    <tr>
