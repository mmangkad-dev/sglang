...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Force cold- or hot-L2 profiling during autotune. Unset inherits FlashInfer's per-op default. Also part of the store identity.</td>
