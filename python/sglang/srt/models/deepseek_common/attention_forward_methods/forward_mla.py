...
if TYPE_CHECKING:
    from sglang.srt.models.deepseek_common.index_cache import TopkIndices
        ...
        if self.q_lora_rank is not None:
            ...
            if (
                ...
                if not self.skip_topk:
                    ...
                    topk_indices = self._require_prev_topk_indices(prev_topk_indices)
                current_stream.wait_stream(self.alt_stream)
            else:
                k_nope = k_nope.unsqueeze(1)
                ...
                if q_lora is not None:
                    if not self.skip_topk:
                        ...
                        topk_indices = self._require_prev_topk_indices(
                            prev_topk_indices
                        )
        else:
