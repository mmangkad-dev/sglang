...
class LayerCommunicator:
    ...
    def should_defer_mlp_allreduce(self, forward_batch: ForwardBatch) -> bool:
        ...
        performs it itself during ``postprocess_layer``. Distinct from
        ``should_fuse_mlp_allreduce_with_next_layer``, which hands the reduction
        to the next layer and skips ``postprocess_layer`` entirely."""
        return False
