...
class DefaultModelLoader(BaseModelLoader):
    ...
    def __init__(self, load_config: LoadConfig):
        ...
        if load_config.load_format == LoadFormat.FASTSAFETENSORS:
            allowed_keys.update({"enable_gds", "max_threads"})
            ...
            if "max_threads" in extra_config and (
                isinstance(extra_config["max_threads"], bool)
                or not isinstance(extra_config["max_threads"], int)
                or extra_config["max_threads"] <= 0
            ):
                raise ValueError(
                    "max_threads in --model-loader-extra-config must be a positive integer"
                )
    ...
    def _get_weights_iterator(
        ...
        if self.load_config.load_format == LoadFormat.NPCACHE:
            ...
            if self.load_config.load_format == LoadFormat.FASTSAFETENSORS:
                ...
                max_threads = extra_config.get("max_threads", 16)
