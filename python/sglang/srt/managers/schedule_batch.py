...
from sglang.srt.disaggregation.utils import DisaggregationMode, is_fake_transfer
...
class Req(ReqDllmMixin):
    ...
    def __init__(
        ...
        # A fake-transfer request's KV is fully real only on the prefill side,
        # where a normal forward computes it.
        # On decode, matched or restored positions hold real KV,
        # but the rest of the input positions were never written,
        ...
        self.skip_radix_cache_insert = (
            disagg_mode == DisaggregationMode.DECODE and is_fake_transfer(self)
        )
